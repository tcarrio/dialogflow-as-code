...
export function jsonToStructProto(json: any): any {
  ...
  for (const jsonKey of Object.keys(json)) {
    ...
    fields[jsonKey] = jsonValueToProto(json[jsonKey]);
  }
...
function jsonValueToProto(value: any): any {
...
export function structProtoToJson(proto: any): any {
...
function valueProtoToJson(proto: any): any {
  if (!proto || !proto.kind) {
    return null;
  }
